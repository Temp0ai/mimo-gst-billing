...
sealed class Screen(val route: String) {
    ...
    object GstinVerify : Screen("gstin_verify?gstin={gstin}") {
        fun createRoute(gstin: String = "") = "gstin_verify?gstin=$gstin"
    }
    ...
    object OtherIncomeReport : Screen("other_income_report")
    object PartiesForReview : Screen("parties_for_review")
    object Vat201Return : Screen("vat_201_return")
    object CustomHeaderFooter : Screen("custom_header_footer")
    object TransactionThemeChooser : Screen("transaction_theme_chooser")
    object AdditionalItemColumns : Screen("additional_item_columns")
    object AutoSyncSettings : Screen("auto_sync_settings")
    object GroupPartyBulkSend : Screen("group_party_bulk_send")
    object GreetingOfferCards : Screen("greeting_offer_cards")
    ...
    object SalesTrend : Screen("sales_trend")
    object PartyRisk : Screen("party_risk")
    object GstFiling : Screen("gst_filing")
    object ExpenseOptimizer : Screen("expense_optimizer")
    object BusinessHealth : Screen("business_health")
    object SmartInvoiceSuggest : Screen("smart_invoice_suggest")
    object PaymentPattern : Screen("payment_pattern")
}
